...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:eternity-ii",
    "quantifiers": [
      {
    ...
    "statement": {
      "language": "en",
      "text": "Draft bounty intake target: Eternity II puzzle. The exact mathematical statement, quantifiers, definitions, assumptions, and acceptance conditions have not yet been frozen; this draft is not research-admitted.",
      "version": 1
    },
    "title": "Eternity II puzzle",
    "updated_at": "2026-09-08T08:24:29Z"
  },
  "problem_contract_sha256": "6f60c2669d44c53d5b02900e340f001b7fdba76ba3454b813530b79d3e583b1c"
}
```
